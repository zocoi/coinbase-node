...
Client.prototype.getAccounts = function(args) {
  return new Promise((resolve, reject) => {
    ...
    this._getAllHttp(_.assign(args || {}, opts), (err, result) => err
      ? reject(err)
      : resolve(result));
  });
};
...
Client.prototype.getAccount = function(account_id) {
  return new Promise((resolve, reject) => {
    ...
    this._getOneHttp(opts, (err, result) => err
      ? reject(err)
      : resolve(result));
  });
};

Client.prototype.getAccountBuys = function(account_id) {
  return new Promise((resolve, reject) => {
    var opts = {
      'colName': "accounts/${account_id}/buys",
      'ObjFunc': Buy
    };
    this._getAllHttp(opts, (err, result) => err
      ? reject(err)
      : resolve(result));
  });
};

Client.prototype.getAccountSells = function(account_id) {
  return new Promise((resolve, reject) => {
    var opts = {
      'colName': "accounts/${account_id}/sells",
      'ObjFunc': Sell
    };
    this._getAllHttp(opts, (err, result) => err
      ? reject(err)
...
Client.prototype.createAccount = function(args) {
  return new Promise((resolve, reject) => {
    ...
    this._postOneHttp(opts, (err, result) => err
      ? reject(err)
      : resolve(result));
  });
};
